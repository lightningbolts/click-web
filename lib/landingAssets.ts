/** Central paths for home page / landing imagery (served from `public/landing/`). */
export const LANDING_IMG = {
  memoryDashboard: '/landing/consumer-memory-dashboard.png',
  mapMobileSoundtracks: '/landing/consumer-map-mobile-soundtracks.png',
  profileMobile: '/landing/consumer-profile-mobile.png',
  homeMobile: '/landing/consumer-home-mobile.png',
  addClick: '/landing/consumer-add-click.png',
  groupChat: '/landing/consumer-group-chat-web.png',
  mapWeb: '/landing/consumer-map-web.png',
