...
-- Official copy: supabase/migrations/20260831000000_event_auto_hubs.sql
--
-- What this does:
...
--     via LEFT JOIN hub_venues (not a map_beacons column)
--
-- Do not add map_beacons.hub_id — that column does not exist. Clients also
-- read metadata.hub_id written by createHubForEventBeacon.
--
