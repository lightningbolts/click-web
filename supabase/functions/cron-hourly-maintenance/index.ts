/**
 * Hourly maintenance (replaces Vercel `vercel.json` crons):
 *   1. Disposable Roll reveal pushes after collaboration_ttl
 *   2. failed_conversion rows in system_friction_logs for expired availability intents
 *
 * Deploy:
...
Deno.serve(async (req: Request) => {
  ...
  try {
    ...
    const body = { ok: true, disposable, friction };
