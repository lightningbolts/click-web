...
- **Docs:** `docs/ui-ux/01-design-system-web.md` (and 02–04 for landing/dashboard/insights). Landing playground map is client-only (`playgroundMapStyle.ts`); do not wire it to Carto or `/api/map`.
