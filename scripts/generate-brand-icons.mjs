/**
 * Renders public/brand/logo-icon.svg to favicon.ico, apple-touch-icon.png, and icon.png.
 * Run: npm run icons
 */
...
async function main() {
  ...
  console.log("Wrote public/icon.png, apple-touch-icon.png, favicon.ico and app/favicon.ico from brand/logo-icon.svg");
}
